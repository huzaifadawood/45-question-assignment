...
var newName = ["admin", "ayan", "hamza", "hammad", "areeb"];
var new_users = ["huzzi", "jawad", "faizan", "sufi", "bilal"];
// Function to check if username is available
function isUsernameAvailable(username) {
    var lowercase_current_users = newName.map(function (user) { return user.toLowerCase(); });
